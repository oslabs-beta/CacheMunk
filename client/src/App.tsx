...
const App: React.FC = () => (
  ...
  <div className="div">
    ...
    <Switch className="switch-2" disabled={false} ellipseClassName="switch-instance" selected={false} />
    <InputSlot className="input-slot-instance" divClassName="design-component-instance-node" text="Cache Switch" />
